...
class Borrowed_model extends CI_Model
{
	...
	public function getDataByRole($condition = array(), $limit = 30, $offset = 0)
	{
		...
		if (isset($condition['created_by']) && $condition['created_by'] != "1") {
			$where['created_by.email'] = $condition['created_by'];
		}
		if (isset($condition['created_by']) && $condition['created_by'] == "1") {
			$where['created_by.email'] = array('$in' => ["sangnv@tienngay.vn", "vulq@tienngay.vn"]);
		}
